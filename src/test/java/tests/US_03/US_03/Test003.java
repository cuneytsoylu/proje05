...
public class Test003 extends TestBaseRapor {
    ...
    public void TC01() {
        ...
        extentTest = extentReports.createTest("Vendor olarak urun ekleyip eklenen uruneleri sepette gorebilmeli");
    ...
    public void TC04() {
        ...
        actions.sendKeys(Keys.TAB).sendKeys("5426546786").sendKeys(Keys.TAB).sendKeys(Keys.TAB).
                sendKeys(Keys.TAB).sendKeys("Iste Bu Kadar").sendKeys(Keys.ENTER).perform();
